...
public class Audio {
    public static void main(String[] args) throws UnsupportedAudioFileException, IOException, LineUnavailableException {
        ...
        File musicFile = new File("/Users/pazzavala/Desktop/Java Projects/smallJavaProjects/src/Basic/Audio/Rihanna - Lift Me Up (From Black Panther： Wakanda Forever).wav");
